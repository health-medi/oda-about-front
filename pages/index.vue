<template>
  ...
  <section>
    <img
      class="absolute bottom-32 md:bottom-56 z-10 left-1/2 translate-x-[-50%] w-[300px] md:w-auto"
      src="@/assets/images/main/box201.png"
      alt="날씬함이 아름다움이 오다"
      data-scroll="toggle(.aniLeftIn, .aniLeftOut)"
    />
    <img
  ...
  <section class="bg-zinc-800 py-16 md:py-44">
    <div class="md:flex text-center *:flex-1 w-full md:w-[1040px] mx-auto">
      <ul>
  ...
  <section class="text-center py-20 md:py-40">
    ...
    >
      <img
        class="banner w-[120px] md:w-[241px]"
        src="@/assets/images/main/box301.png"
      />
      <img
        class="banner top-12 w-[120px] md:w-[241px]"
  ...
  <section>
    <img
      class="absolute top-1/3 z-10 left-10 md:left-1/4 w-[238.5px] md:w-auto"
  ...
  <section class="relative">
    <div class="absolute text-center top-14 md:top-52 z-10 w-full">
      ...
      <ul
        ref="scrollElement"
        class="absolute w-px md:w-0.5 top-12 md:top-24 h-12 md:h-36 left-1/2 bg-stone-700"
      ></ul>
    </div>
    <img
      class="relative max-w-[150%] md:max-w-[1920px] left-1/2 translate-x-[-50%]"
  ...
  <section
    class="bg-[url('@/assets/images/main/box6bg.png')] text-center md:text-left"
  >
    <article
      class="md:flex items-center justify-between w-full md:w-[1150px] my-16 md:my-32 mx-auto p-6 md:p-0"
    >
      <div class="md:w-[455px]" data-scroll="toggle(.anidep1, .aniout)">
        <span
  ...
  <section class="bg-white text-center md:text-left">
    ...
    >
      <div class="md:w-[480px]" data-scroll="toggle(.anidep1, .aniout)">
        <span
  ...
  <section
    class="bg-[#e7f4ff] md:bg-[url('@/assets/images/main/box7bg.png')] bg-center text-center md:text-left md:h-[840px]"
  >
    <article
      class="md:flex items-center justify-between w-full md:w-[1150px] my-16 md:my-60 mx-auto p-6 md:p-0"
    >
      <div class="md:w-[440px]" data-scroll="toggle(.anidep1, .aniout)">
        <span
          class="rounded-full bg-white text-[#FF6079] font-bold text-base md:text-lg py-3 px-6"
          >Point 3</span
        >
  ...
  <section class="bg-white text-center md:text-left">
    <article
      class="md:flex flex-row-reverse items-center justify-between w-full md:w-[1150px] my-16 md:my-32 mx-auto p-6 md:p-0"
    >
      <div class="md:w-[420px]" data-scroll="toggle(.anidep1, .aniout)">
        <span
          class="rounded-full bg-[#FEF2F2] text-[#FF6079] font-bold text-base md:text-lg py-3 px-6"
          >Point 4
        </span>
  ...
  <section class="text-white text-center">
    <div class="absolute top-1/3 md:top-1/2 z-10 w-full">
...
const initBannerAnimation = () => {
  ...
  let bannerWidth = $banners[0].offsetWidth + 30; // 배너 너비 + 간격
